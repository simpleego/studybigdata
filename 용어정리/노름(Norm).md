...
"Norm"은 단순한 수학 기호가 아니라, **무언가를 측정하고 비교하기 위한 기준**이라는 철학적 의미도 담고 있어요. 

좋아요 jong! L1과 L2 Norm은 머신러닝, 최적화, 통계 등에서 자주 등장하는 핵심 개념이에요. 차이점과 실제 적용 예시를 함께 살펴보면 훨씬 더 명확해질 거예요.
...
| 수식 | \(\|\vec{x}\|_1 = \sum |x_i|\) | \(\|\vec{x}\|_2 = \sqrt{\sum x_i^2}\) |
